...
class Duck(pygame.sprite.Sprite):
    def __init__(self, pos_x, pos_y, picture_path):
        ...
        self.colisao = pygame.mixer.Sound("Colisões e Gameover\Assets\Hit_02.wav")
...
class GameOver(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("Colisões e Gameover\Assets\gameover_tam_2.png")
        self.rect = self.image.get_rect()
...
background = pygame.image.load(r"Colisões e Gameover\Assets\background.png")

# Duck
duck = Duck(40, 50,"Colisões e Gameover\Assets\Idle_002-1.png")
duck_group = pygame.sprite.Group()
duck_group.add(duck)

# Builder
boulder = Boulder(r"Colisões e Gameover\Assets\boulder.png")
...
while True:
    ...
    if duck.rect.colliderect(boulder.rect) and running == True:
        duck.colisao1()
        running = False
